  ...
  implements Menu
{
  ...
  public int addIntentOptions(int paramInt1, int paramInt2, int paramInt3, ComponentName paramComponentName, Intent[] paramArrayOfIntent, Intent paramIntent, int paramInt4, MenuItem[] paramArrayOfMenuItem)
  {
    ...
    int k = ((SupportMenu)this.mWrappedObject).addIntentOptions(paramInt1, paramInt2, paramInt3, paramComponentName, paramArrayOfIntent, paramIntent, paramInt4, arrayOfMenuItem);
    int i;
    int j;
    if (arrayOfMenuItem != null)
    {
      i = 0;
      j = arrayOfMenuItem.length;
    }
    for (;;)
    {
      if (i >= j) {
      ...
      paramArrayOfMenuItem[i] = getMenuItemWrapper(arrayOfMenuItem[i]);
      i++;
    }
  }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v7\internal\view\menu\MenuWrapperICS.class
