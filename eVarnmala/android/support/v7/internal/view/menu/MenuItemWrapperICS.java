  ...
  implements MenuItem
{
  ...
  {
    Object localObject = ((SupportMenuItem)this.mWrappedObject).getSupportActionProvider();
    if (!(localObject instanceof ActionProviderWrapper)) {
      localObject = null;
    } else {
      localObject = ((ActionProviderWrapper)localObject).mInner;
    }
    return (android.view.ActionProvider)localObject;
  }
  ...
  public MenuItem setActionProvider(android.view.ActionProvider paramActionProvider)
  {
    ...
    ActionProviderWrapper localActionProviderWrapper;
    if (paramActionProvider == null) {
      localActionProviderWrapper = null;
    } else {
      localActionProviderWrapper = createActionProviderWrapper(paramActionProvider);
    }
  ...
  public void setExclusiveCheckable(boolean paramBoolean)
  {
    try
    {
      ...
      {
        localObject2 = ((SupportMenuItem)this.mWrappedObject).getClass();
        localObject1 = new Class[1];
        localObject1[0] = Boolean.TYPE;
        this.mSetExclusiveCheckableMethod = ((Class)localObject2).getDeclaredMethod("setExclusiveCheckable", (Class[])localObject1);
      }
      Object localObject1 = this.mSetExclusiveCheckableMethod;
      Object localObject2 = this.mWrappedObject;
  ...
  {
    SupportMenuItem localSupportMenuItem = (SupportMenuItem)this.mWrappedObject;
    OnActionExpandListenerWrapper localOnActionExpandListenerWrapper;
    if (paramOnActionExpandListener == null) {
      localOnActionExpandListenerWrapper = null;
    } else {
      localOnActionExpandListenerWrapper = new OnActionExpandListenerWrapper(paramOnActionExpandListener);
    }
  ...
  {
    SupportMenuItem localSupportMenuItem = (SupportMenuItem)this.mWrappedObject;
    OnMenuItemClickListenerWrapper localOnMenuItemClickListenerWrapper;
    if (paramOnMenuItemClickListener == null) {
      localOnMenuItemClickListenerWrapper = null;
    } else {
      localOnMenuItemClickListenerWrapper = new OnMenuItemClickListenerWrapper(paramOnMenuItemClickListener);
    }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v7\internal\view\menu\MenuItemWrapperICS.class
