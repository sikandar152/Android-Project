  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (m == 1073741824)
    {
      ...
      int i2 = k - m;
      int n = View.MeasureSpec.makeMeasureSpec((int)(0.8F * i), Integer.MIN_VALUE);
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    i = View.MeasureSpec.makeMeasureSpec((int)(0.8F * i), Integer.MIN_VALUE);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    i9 = i6 + this.mCurrText.getMeasuredHeight();
    int i10 = i8 + this.mNextText.getMeasuredHeight();
    i9 = Math.max(Math.max(i11, i9), i10);
    ...
    i7 = i5 + this.mCurrText.getMeasuredHeight();
    localTextView3.layout(i2, i5, i1, i7);
    n = Math.min(n, i2 - this.mScaledTextSpacing - m);
    TextView localTextView2 = this.mPrevText;
    i5 = n + m;
    m = i4 + this.mPrevText.getMeasuredHeight();
    localTextView2.layout(n, i4, i5, m);
    j = Math.max(j - k - i, i1 + this.mScaledTextSpacing);
    TextView localTextView1 = this.mNextText;
    m = j + i;
    i = i3 + this.mNextText.getMeasuredHeight();
    localTextView1.layout(j, i3, m, i);
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\view\PagerTitleStrip.class
