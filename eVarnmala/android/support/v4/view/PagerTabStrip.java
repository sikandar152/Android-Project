  ...
  extends PagerTitleStrip
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    int k = i - this.mIndicatorHeight;
    this.mTabPaint.setColor(this.mTabAlpha << 24 | 0xFFFFFF & this.mIndicatorColor);
    paramCanvas.drawRect(m, k, j, i, this.mTabPaint);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    int m = this.mCurrText.getRight() + this.mTabPadding;
    int i = j - this.mIndicatorHeight;
    localRect.set(k, i, m, j);
    super.updateTextPositions(paramInt, paramFloat, paramBoolean);
    this.mTabAlpha = ((int)(255.0F * (2.0F * Math.abs(paramFloat - 0.5F))));
    localRect.union(this.mCurrText.getLeft() - this.mTabPadding, i, this.mCurrText.getRight() + this.mTabPadding, j);
    invalidate(localRect);
  }
}


/* Location:              E:\classes_dex2jar.jar!\android\support\v4\view\PagerTabStrip.class
