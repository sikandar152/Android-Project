...
public class RoundedBitmapDrawableFactory
{
  ...
  public static RoundedBitmapDrawable create(Resources paramResources, Bitmap paramBitmap)
  {
    ...
    if (Build.VERSION.SDK_INT < 21) {
      localObject = new DefaultRoundedBitmapDrawable(paramResources, paramBitmap);
    } else {
      localObject = new RoundedBitmapDrawable21(paramResources, paramBitmap);
    }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\graphics\drawable\RoundedBitmapDrawableFactory.class
