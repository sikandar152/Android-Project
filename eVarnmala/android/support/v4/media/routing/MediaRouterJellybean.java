...
class MediaRouterJellybean
{
  ...
  public static List getCategories(Object paramObject)
  {
    ...
    for (int i = 0;; i++)
    {
      ...
      localArrayList.add(localMediaRouter.getCategoryAt(i));
    }
  }
  ...
  public static List getRoutes(Object paramObject)
  {
    ...
    for (int i = 0;; i++)
    {
      ...
      localArrayList.add(localMediaRouter.getRouteAt(i));
    }
  }
  ...
  public static final class GetDefaultRouteWorkaround
  {
    ...
    {
      localObject = (MediaRouter)paramObject;
      if (this.mGetSystemAudioRouteMethod != null) {}
      try
      {
        localObject = this.mGetSystemAudioRouteMethod.invoke(localObject, new Object[0]);
      ...
      catch (InvocationTargetException localInvocationTargetException)
      {
        for (;;)
        {
          localObject = ((MediaRouter)localObject).getRouteAt(0);
        }
      }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\media\routing\MediaRouterJellybean.class
