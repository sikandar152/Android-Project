  ...
  extends Fragment
{
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    FrameLayout localFrameLayout = new FrameLayout((Context)localObject1);
    Object localObject2 = new LinearLayout((Context)localObject1);
    ((LinearLayout)localObject2).setId(16711682);
    ((LinearLayout)localObject2).setOrientation(1);
    ((LinearLayout)localObject2).setVisibility(8);
    ((LinearLayout)localObject2).setGravity(17);
    ((LinearLayout)localObject2).addView(new ProgressBar((Context)localObject1, null, 16842874), new FrameLayout.LayoutParams(-2, -2));
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\ListFragment.class
