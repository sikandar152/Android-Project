  ...
  extends Service
{
  ...
  {
    NotificationSideChannelStub localNotificationSideChannelStub = null;
    if ((paramIntent.getAction().equals("android.support.BIND_NOTIFICATION_SIDE_CHANNEL")) && (Build.VERSION.SDK_INT <= 19)) {
      localNotificationSideChannelStub = new NotificationSideChannelStub(null);
    }
    return localNotificationSideChannelStub;
  }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\NotificationCompatSideChannelService.class
