  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  public boolean getAllowEnterTransitionOverlap()
  {
    ...
    if (this.mAllowEnterTransitionOverlap != null) {
      bool = this.mAllowEnterTransitionOverlap.booleanValue();
    } else {
      bool = true;
    }
    return bool;
  ...
  public boolean getAllowReturnTransitionOverlap()
  {
    ...
    if (this.mAllowReturnTransitionOverlap != null) {
      bool = this.mAllowReturnTransitionOverlap.booleanValue();
    } else {
      bool = true;
    }
    return bool;
  ...
  public Object getReenterTransition()
  {
    ...
    if (this.mReenterTransition != USE_DEFAULT_TRANSITION) {
      localObject = this.mReenterTransition;
    } else {
  ...
  public Object getReturnTransition()
  {
    ...
    if (this.mReturnTransition != USE_DEFAULT_TRANSITION) {
      localObject = this.mReturnTransition;
    } else {
  ...
  public Object getSharedElementReturnTransition()
  {
    ...
    if (this.mSharedElementReturnTransition != USE_DEFAULT_TRANSITION) {
      localObject = this.mSharedElementReturnTransition;
    } else {
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\Fragment.class
