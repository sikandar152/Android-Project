  ...
  extends IInterface
{
    ...
    implements INotificationSideChannel
  {
    ...
    public static INotificationSideChannel asInterface(IBinder paramIBinder)
    {
      ...
      {
        localObject = paramIBinder.queryLocalInterface("android.support.v4.app.INotificationSideChannel");
        if ((localObject == null) || (!(localObject instanceof INotificationSideChannel))) {
          localObject = new Proxy(paramIBinder);
        } else {
          localObject = (INotificationSideChannel)localObject;
        }
      }
      else
      {
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\INotificationSideChannel.class
