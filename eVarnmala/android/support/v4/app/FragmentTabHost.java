  ...
  implements TabHost.OnTabChangeListener
{
  ...
  protected void onAttachedToWindow()
  {
    ...
    FragmentTransaction localFragmentTransaction2 = null;
    FragmentTransaction localFragmentTransaction1;
    for (int i = 0;; localFragmentTransaction1++)
    {
      if (i >= this.mTabs.size())
      {
        this.mAttached = true;
        localFragmentTransaction1 = doTabChanged(str, localFragmentTransaction2);
      ...
      TabInfo localTabInfo = (TabInfo)this.mTabs.get(localFragmentTransaction1);
      ...
      if ((localTabInfo.fragment != null) && (!localTabInfo.fragment.isDetached())) {
        if (!localTabInfo.tag.equals(str))
        {
          if (localFragmentTransaction2 == null) {
            localFragmentTransaction2 = this.mFragmentManager.beginTransaction();
          }
          localFragmentTransaction2.detach(localTabInfo.fragment);
        }
        else
        {
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\FragmentTabHost.class
