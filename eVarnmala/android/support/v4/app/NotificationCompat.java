...
public class NotificationCompat
{
    ...
    if (paramStyle != null)
    {
      ...
      if (!(paramStyle instanceof BigTextStyle))
      {
        if (!(paramStyle instanceof InboxStyle))
        {
          ...
          {
            localObject = (BigPictureStyle)paramStyle;
            NotificationCompatJellybean.addBigPictureStyle(paramNotificationBuilderWithBuilderAccessor, ((BigPictureStyle)localObject).mBigContentTitle, ((BigPictureStyle)localObject).mSummaryTextSet, ((BigPictureStyle)localObject).mSummaryText, ((BigPictureStyle)localObject).mPicture, ((BigPictureStyle)localObject).mBigLargeIcon, ((BigPictureStyle)localObject).mBigLargeIconSet);
          }
        }
        else
        {
          localObject = (InboxStyle)paramStyle;
          NotificationCompatJellybean.addInboxStyle(paramNotificationBuilderWithBuilderAccessor, ((InboxStyle)localObject).mBigContentTitle, ((InboxStyle)localObject).mSummaryTextSet, ((InboxStyle)localObject).mSummaryText, ((InboxStyle)localObject).mTexts);
        }
      }
      else
      {
        localObject = (BigTextStyle)paramStyle;
        NotificationCompatJellybean.addBigTextStyle(paramNotificationBuilderWithBuilderAccessor, ((BigTextStyle)localObject).mBigContentTitle, ((BigTextStyle)localObject).mSummaryTextSet, ((BigTextStyle)localObject).mSummaryText, ((BigTextStyle)localObject).mBigText);
      }
    }
  }
  ...
  private static Notification[] getNotificationArrayFromBundle(Bundle paramBundle, String paramString)
  {
    ...
    Notification[] arrayOfNotification = (Notification[])arrayOfParcelable;
    ...
    public CarExtender(Notification paramNotification)
    {
      if (Build.VERSION.SDK_INT >= 21)
      {
        ...
        if (localBundle != null)
        {
          ...
          localBundle = localBundle.getBundle("car_conversation");
          this.mUnreadConversation = ((UnreadConversation)NotificationCompat.IMPL.getUnreadConversationFromBundle(localBundle, UnreadConversation.FACTORY, RemoteInput.FACTORY));
        }
      }
    }
    ...
    implements NotificationCompat.Extender
  {
    ...
    public WearableExtender(Notification paramNotification)
    {
      ...
      if (localBundle == null) {
        ...
        localBundle = localBundle.getBundle("android.wearable.EXTENSIONS");
      }
      if (localBundle != null)
      {
        Object localObject = NotificationCompat.IMPL.getActionsFromParcelableArrayList(localBundle.getParcelableArrayList("actions"));
        if (localObject != null) {
          Collections.addAll(this.mActions, (Object[])localObject);
        }
        this.mFlags = localBundle.getInt("flags", 1);
        this.mDisplayIntent = ((PendingIntent)localBundle.getParcelable("displayIntent"));
        localObject = NotificationCompat.getNotificationArrayFromBundle(localBundle, "pages");
        if (localObject != null) {
          Collections.addAll(this.mPages, (Object[])localObject);
        }
        this.mBackground = ((Bitmap)localBundle.getParcelable("background"));
        this.mContentIcon = localBundle.getInt("contentIcon");
        this.mContentIconGravity = localBundle.getInt("contentIconGravity", 8388613);
        this.mContentActionIndex = localBundle.getInt("contentActionIndex", -1);
        this.mCustomSizePreset = localBundle.getInt("customSizePreset", 0);
        this.mCustomContentHeight = localBundle.getInt("customContentHeight");
        this.mGravity = localBundle.getInt("gravity", 80);
        this.mHintScreenTimeout = localBundle.getInt("hintScreenTimeout");
      }
    }
    ...
    public static final class Builder
    {
      ...
      public NotificationCompat.Action build()
      {
        ...
        if (this.mRemoteInputs == null) {
          ...
          arrayOfRemoteInput = (RemoteInput[])this.mRemoteInputs.toArray(new RemoteInput[this.mRemoteInputs.size()]);
        }
  ...
  public static class Builder
  {
    ...
    {
      if ((paramCharSequence != null) && (paramCharSequence.length() > 5120)) {
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\NotificationCompat.class
