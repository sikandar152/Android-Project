  ...
  implements Iterable<Intent>
{
  ...
  public TaskStackBuilder addParentStack(ComponentName paramComponentName)
  {
    ...
    try
    {
      for (Intent localIntent = NavUtils.getParentActivityIntent(this.mSourceContext, paramComponentName); localIntent != null; localIntent = localIntent)
      {
  ...
  public void startActivities(Bundle paramBundle)
  {
    if (!this.mIntents.isEmpty())
    {
      ...
      {
        localObject = new Intent(localObject[(-1 + localObject.length)]);
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\app\TaskStackBuilder.class
