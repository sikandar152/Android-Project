    ...
    synchronized (sInstances)
    {
      ...
      if (localObject1 == null)
      {
        if (Build.VERSION.SDK_INT >= 17)
        {
          ...
          sInstances.put(paramContext, localObject1);
        }
      }
      else {
        return (DisplayManagerCompat)localObject1;
      }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\hardware\display\DisplayManagerCompat.class
