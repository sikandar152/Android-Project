      ...
      if (!this.mTempParentRect.isEmpty())
      {
        ...
        if ((i & 0x40) == 0)
        {
          if ((i & 0x80) == 0)
          {
            ...
            i = this.mTempGlobalRect[0];
            int j = this.mTempGlobalRect[1];
            this.mTempScreenRect.set(this.mTempParentRect);
            this.mTempScreenRect.offset(i, j);
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\widget\ExploreByTouchHelper.class
