    ...
    implements ScrollerCompat.ScrollerCompatImpl
  {
    ...
    public Object createScroller(Context paramContext, Interpolator paramInterpolator)
    {
      ...
      if (paramInterpolator == null) {
        localScroller = new Scroller(paramContext);
      } else {
        localScroller = new Scroller(paramContext, paramInterpolator);
      }
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\widget\ScrollerCompat.class
