  ...
  implements Interpolator
{
  ...
  static
  {
    ...
    arrayOfFloat[0] = 0.0F;
    arrayOfFloat[1] = 2.0E-4F;
    arrayOfFloat[2] = 9.0E-4F;
  ...
  public float getInterpolation(float paramFloat)
  {
    ...
    if (paramFloat < f1) {
      if (paramFloat > 0.0F)
      {
        ...
        float f3 = (paramFloat - i * STEP_SIZE) / STEP_SIZE;
        f2 = VALUES[i] + f3 * (VALUES[(i + 1)] - VALUES[i]);
      }
      else
      {
        f2 = 0.0F;
...
/* Location:              E:\classes_dex2jar.jar!\android\support\v4\widget\BakedBezierInterpolator.class
