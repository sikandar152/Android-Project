...
public class Profile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.execSQL("create table if not exists login1(name varchar,mobile_no varchar,email_id varchar,password varchar,flag varchar)");
    ...
    public void action(View v)
    {
        ...
        {
            case R.id.login1:
                i=new Intent(this,LoginUser.class);
            ...
            case R.id.signin:
                ...
                {
                    db.execSQL("insert into login1 values('"+name+"','"+mobile_no+"','"+email_id+"','"+password+"','nothing')");
